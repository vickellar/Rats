...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="fpdf-info">
                <h4><i class="fas fa-info-circle"></i> PDF Export Information</h4>
                <p>PDF reports are generated using FPDF library with professional formatting, headers, footers, and comprehensive summary statistics.</p>
            </div>
            ...
            <div class="toolbar">
                ...
                <div class="export-buttons">
                    <form method="POST" action="export_pdf_fpdf.php" style="display: inline;">
                        ...
                        <?php if (count($properties) > 0): ?>
                            <?php foreach ($properties as $property): ?>
                                <tr>
                                    ...
                                    <td><span class="account-numbers"><?php echo htmlspecialchars($property['account_numbers'] ?: 'None'); ?></span></td>
                                </tr>
                            <?php endforeach; ?>
                        <?php else: ?>
                            <tr>
